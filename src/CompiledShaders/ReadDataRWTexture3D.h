...
; inputTexture                          UAV     f32          3d      U1             u1     1
;
...
@"\01?inputTexture@@3V?$RWTexture3D@V?$vector@M$03@@@@A" = external constant %"class.RWTexture3D<vector<float, 4> >", align 4
...
define void @"\01?miss@@YAXUEmptyPayload@@@Z"(%struct.EmptyPayload* noalias %payload) #0 {
  ...
  %1 = alloca [4 x float]
  %2 = alloca [4 x float]
  %3 = load %"class.RWTexture3D<vector<float, 4> >", %"class.RWTexture3D<vector<float, 4> >"* @"\01?inputTexture@@3V?$RWTexture3D@V?$vector@M$03@@@@A"
  ...
  %6 = load i32, i32* %5
  store i32 %6, i32* %.0
  %7 = call %dx.types.Handle @"dx.op.createHandleForLib.class.RWTexture3D<vector<float, 4> >"(i32 160, %"class.RWTexture3D<vector<float, 4> >" %3)  ; CreateHandleForLib(Resource)
  %TextureLoad = call %dx.types.ResRet.f32 @dx.op.textureLoad.f32(i32 66, %dx.types.Handle %7, i32 undef, i32 0, i32 0, i32 0, i32 undef, i32 undef, i32 undef)  ; TextureLoad(srv,mipLevelOrSampleCount,coord0,coord1,coord2,offset0,offset1,offset2)
...
; Function Attrs: nounwind readonly
declare %dx.types.Handle @"dx.op.createHandleForLib.class.RWTexture3D<vector<float, 4> >"(i32, %"class.RWTexture3D<vector<float, 4> >") #1
...
!7 = !{i32 1, %"class.RWTexture3D<vector<float, 4> >"* @"\01?inputTexture@@3V?$RWTexture3D@V?$vector@M$03@@@@A", !"inputTexture", i32 0, i32 1, i32 1, i32 4, i1 false, i1 false, i1 false, !8}
!8 = !{i32 0, i32 9}
!9 = !{i32 0, %struct.RWByteAddressBuffer undef, !10, %struct.EmptyPayload undef, !12, %"class.RWTexture3D<vector<float, 4> >" undef, !14}
!10 = !{i32 4, !11}
...
const unsigned char g_pReadDataRWTexture3D[] = {
  ...
  0x25, 0x51, 0x06, 0xe5, 0x50, 0x0a, 0x05, 0x52, 0x04, 0x05, 0x41, 0xba,
  ...
  0x95, 0x4d, 0x10, 0x80, 0x65, 0x82, 0x00, 0x30, 0x1b, 0x84, 0x42, 0xda,
  0xb0, 0x0c, 0x0f, 0x54, 0x0c, 0x43, 0xd4, 0x34, 0xcd, 0xb4, 0x41, 0x70,
  0xa8, 0x0d, 0x04, 0x50, 0x01, 0xc0, 0x04, 0x21, 0xb8, 0x18, 0xa0, 0x4d,
  0x10, 0x80, 0x66, 0x82, 0x00, 0x38, 0x1b, 0x0c, 0x04, 0xcb, 0x0a, 0x2d,
  0xda, 0x20, 0x44, 0xdb, 0x04, 0x01, 0xa9, 0x18, 0xa4, 0x4d, 0x10, 0x80,
  0x67, 0x83, 0x81, 0x78, 0x59, 0xa1, 0x7d, 0x1b, 0x84, 0x08, 0x0c, 0x26,
  0x08, 0x85, 0x35, 0x41, 0x00, 0xa0, 0x0d, 0x06, 0x82, 0x65, 0x85, 0x26,
  0x6d, 0x10, 0xc6, 0x80, 0x0c, 0x36, 0x1c, 0xc5, 0xc5, 0x75, 0x61, 0x20,
  ...
  0x41, 0x9b, 0x36, 0x08, 0xc5, 0x1b, 0x6c, 0x28, 0x00, 0x37, 0x00, 0x2c,
  ...
  0x1c, 0x30, 0x48, 0xb4, 0xa1, 0x38, 0x03, 0x39, 0x00, 0x00, 0x3a, 0xa8,
  ...
  ,
  ...
  0x41, 0xe3, 0x79, 0x5e, 0xd3, 0x34, 0xa3, 0x09, 0x01, 0x30, 0x9a, 0x20,
