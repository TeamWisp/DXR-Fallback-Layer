...
; ------------------------------ ---------- ------- ----------- ------- -------------- ------
; inputTexture                      texture     f32          2d      T0             t1     1
...
@"\01?inputTexture@@3V?$Texture2D@V?$vector@M$03@@@@A" = external constant %"class.Texture2D<vector<float, 4> >", align 4
...
define void @"\01?miss@@YAXUEmptyPayload@@@Z"(%struct.EmptyPayload* noalias %payload) #0 {
  ...
  %1 = alloca [4 x float]
  %2 = alloca [4 x float]
  %3 = load %"class.Texture2D<vector<float, 4> >", %"class.Texture2D<vector<float, 4> >"* @"\01?inputTexture@@3V?$Texture2D@V?$vector@M$03@@@@A"
  ...
  %6 = load i32, i32* %5
  store i32 %6, i32* %.0
  %7 = call %dx.types.Handle @"dx.op.createHandleForLib.class.Texture2D<vector<float, 4> >"(i32 160, %"class.Texture2D<vector<float, 4> >" %3)  ; CreateHandleForLib(Resource)
...
!4 = !{!5, !8, null, null}
!5 = !{!6}
!6 = !{i32 0, %"class.Texture2D<vector<float, 4> >"* @"\01?inputTexture@@3V?$Texture2D@V?$vector@M$03@@@@A", !"inputTexture", i32 0, i32 1, i32 1, i32 2, i32 0, !7}
!7 = !{i32 0, i32 9}
!8 = !{!9}
...
!10 = !{i32 0, %struct.RWByteAddressBuffer undef, !11, %struct.EmptyPayload undef, !13, %"class.Texture2D<vector<float, 4> >" undef, !15, %"class.Texture2D<vector<float, 4> >::mips_type" undef, !18}
!11 = !{i32 4, !12}
...
const unsigned char g_pReadDataTexture2D[] = {
  ...
  0x18, 0x8a, 0xa0, 0x24, 0xca, 0xa2, 0x10, 0xca, 0xa0, 0x1c, 0x4a, 0xa1,
  0x50, 0x0a, 0xa4, 0x20, 0x68, 0x2b, 0x51, 0x40, 0x04, 0xd2, 0x46, 0x00,
  ...
  ,
  ...
  0x11, 0xdc, 0x80, 0x0e, 0xea, 0x90, 0xe1, 0xb9, 0x94, 0xb9, 0xd1, 0xc9,
  ...
  0x81, 0x5a, 0x33, 0xa8, 0x86, 0xcb, 0x77, 0x1e, 0x3f, 0xa0, 0x8a, 0x82,
  0x88, 0xd8, 0xc9, 0x89, 0x08, 0x1f, 0xb9, 0xed, 0x2a, 0xd8, 0x03, 0x32,
  ...
  0x1f, 0xc8, 0x07, 0x00, 0x61, 0x20, 0x00, 0x00, 0x5f, 0x00, 0x00, 0x00,
  ...
  ,
