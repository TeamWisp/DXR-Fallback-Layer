...
; inputTexture                          UAV     f32     2darray      U1             u1     1
;
...
@"\01?inputTexture@@3V?$RWTexture2DArray@V?$vector@M$03@@@@A" = external constant %"class.RWTexture2DArray<vector<float, 4> >", align 4
...
define void @"\01?miss@@YAXUEmptyPayload@@@Z"(%struct.EmptyPayload* noalias %payload) #0 {
  ...
  %1 = alloca [4 x float]
  %2 = alloca [4 x float]
  %3 = load %"class.RWTexture2DArray<vector<float, 4> >", %"class.RWTexture2DArray<vector<float, 4> >"* @"\01?inputTexture@@3V?$RWTexture2DArray@V?$vector@M$03@@@@A"
  ...
  %6 = load i32, i32* %5
  store i32 %6, i32* %.0
  %7 = call %dx.types.Handle @"dx.op.createHandleForLib.class.RWTexture2DArray<vector<float, 4> >"(i32 160, %"class.RWTexture2DArray<vector<float, 4> >" %3)  ; CreateHandleForLib(Resource)
...
!7 = !{i32 1, %"class.RWTexture2DArray<vector<float, 4> >"* @"\01?inputTexture@@3V?$RWTexture2DArray@V?$vector@M$03@@@@A", !"inputTexture", i32 0, i32 1, i32 1, i32 7, i1 false, i1 false, i1 false, !8}
!8 = !{i32 0, i32 9}
!9 = !{i32 0, %struct.RWByteAddressBuffer undef, !10, %struct.EmptyPayload undef, !12, %"class.RWTexture2DArray<vector<float, 4> >" undef, !14}
!10 = !{i32 4, !11}
...
const unsigned char g_pReadDataRWTexture2DArray[] = {
  ...
  0x25, 0x30, 0x02, 0x50, 0x0c, 0x65, 0x51, 0x0e, 0x25, 0x51, 0x08, 0x65,
  ...
  0x65, 0x82, 0x00, 0x30, 0x1b, 0x84, 0x42, 0xda, 0xb0, 0x0c, 0x0f, 0x54,
  0x0c, 0x43, 0xd4, 0x34, 0xcd, 0xb4, 0x41, 0x70, 0xa8, 0x0d, 0x04, 0x50,
  0x01, 0xc0, 0x04, 0x21, 0xb8, 0x26, 0x08, 0x40, 0xc3, 0x00, 0x6d, 0x82,
  0x00, 0x38, 0x1b, 0x0c, 0x24, 0xd3, 0x8a, 0x08, 0xdb, 0x20, 0x60, 0xdb,
  0x04, 0x01, 0xa9, 0x18, 0xa4, 0x4d, 0x10, 0x80, 0x67, 0x83, 0x81, 0x78,
  0x5a, 0x11, 0x7d, 0x1b, 0x04, 0x0c, 0x0c, 0x26, 0x08, 0x85, 0x35, 0x41,
  0x00, 0xa0, 0x0d, 0x06, 0x92, 0x69, 0x45, 0x24, 0x6d, 0x10, 0xc6, 0x80,
  0x0c, 0x36, 0x1c, 0xc5, 0xc5, 0x75, 0x61, 0x20, 0x06, 0x65, 0x30, 0x41,
  ...
  0xc5, 0x1b, 0x6c, 0x28, 0x00, 0x37, 0x00, 0x2c, 0x38, 0x20, 0x17, 0xf0,
  0xd3, 0x96, 0x36, 0x37, 0x07, 0x04, 0x94, 0x15, 0x84, 0x55, 0x55, 0xd4,
  0x06, 0x47, 0x97, 0x07, 0x15, 0x96, 0xc7, 0xf6, 0x16, 0x46, 0x06, 0x04,
  0x04, 0xa4, 0x35, 0x41, 0x00, 0xa4, 0x0d, 0xc4, 0x1c, 0x30, 0x08, 0xb6,
  ...
  ,
  ...
  0xaf, 0xd4, 0x32, 0x9e, 0x5e, 0x97, 0x97, 0x65, 0xc4, 0xa0, 0x5c, 0x1e,
  ...
  0x06, 0xd0, 0x18, 0x2c, 0x41, 0xe3, 0x79, 0x5e, 0xd3, 0x34, 0xa3, 0x09,
