...
; inputTexture                          UAV     f32         buf      U1             u1     1
;
...
@"\01?inputTexture@@3V?$RWBuffer@V?$vector@M$03@@@@A" = external constant %"class.RWBuffer<vector<float, 4> >", align 4
...
define void @"\01?miss@@YAXUEmptyPayload@@@Z"(%struct.EmptyPayload* noalias %payload) #0 {
  ...
  %1 = alloca [4 x float]
  %2 = alloca [4 x float]
  %3 = load %"class.RWBuffer<vector<float, 4> >", %"class.RWBuffer<vector<float, 4> >"* @"\01?inputTexture@@3V?$RWBuffer@V?$vector@M$03@@@@A"
  ...
  %6 = load i32, i32* %5
  store i32 %6, i32* %.0
  %7 = call %dx.types.Handle @"dx.op.createHandleForLib.class.RWBuffer<vector<float, 4> >"(i32 160, %"class.RWBuffer<vector<float, 4> >" %3)  ; CreateHandleForLib(Resource)
  %BufferLoad = call %dx.types.ResRet.f32 @dx.op.bufferLoad.f32(i32 68, %dx.types.Handle %7, i32 0, i32 undef)  ; BufferLoad(srv,index,wot)
  %8 = extractvalue %dx.types.ResRet.f32 %BufferLoad, 0
  %9 = extractvalue %dx.types.ResRet.f32 %BufferLoad, 1
  %10 = extractvalue %dx.types.ResRet.f32 %BufferLoad, 2
  %11 = extractvalue %dx.types.ResRet.f32 %BufferLoad, 3
...
; Function Attrs: nounwind readonly
declare %dx.types.Handle @"dx.op.createHandleForLib.class.RWBuffer<vector<float, 4> >"(i32, %"class.RWBuffer<vector<float, 4> >") #1
...
!7 = !{i32 1, %"class.RWBuffer<vector<float, 4> >"* @"\01?inputTexture@@3V?$RWBuffer@V?$vector@M$03@@@@A", !"inputTexture", i32 0, i32 1, i32 1, i32 10, i1 false, i1 false, i1 false, !8}
!8 = !{i32 0, i32 9}
!9 = !{i32 0, %struct.RWByteAddressBuffer undef, !10, %struct.EmptyPayload undef, !12, %"class.RWBuffer<vector<float, 4> >" undef, !14}
!10 = !{i32 4, !11}
...
const unsigned char g_pReadDataRWBuffer[] = {
  0x44, 0x58, 0x42, 0x43, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
  0x8c, 0x0a, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x2c, 0x00, 0x00, 0x00,
  ...
  0x44, 0x58, 0x49, 0x4c, 0x40, 0x09, 0x00, 0x00, 0x61, 0x00, 0x06, 0x00,
  0x50, 0x02, 0x00, 0x00, 0x44, 0x58, 0x49, 0x4c, 0x01, 0x01, 0x00, 0x00,
  ...
  0x02, 0x00, 0x00, 0x00, 0x89, 0x20, 0x00, 0x00, 0x37, 0x00, 0x00, 0x00,
  ...
  0x46, 0x20, 0x86, 0x99, 0xc2, 0x60, 0x1c, 0xd8, 0x21, 0x1c, 0xe6, 0x61,
  ...
  0x70, 0xa5, 0x60, 0xe0, 0x01, 0x40, 0xb0, 0x0c, 0x0f, 0x04, 0x92, 0x65,
  0x78, 0xa0, 0x10, 0x2d, 0xca, 0x01, 0x0f, 0x00, 0x00, 0x00, 0x68, 0x64,
  0x07, 0x02, 0xe6, 0x08, 0x82, 0x39, 0x02, 0x50, 0x20, 0x90, 0x04, 0x83,
  0x38, 0x0d, 0x00, 0x00, 0x13, 0x14, 0x72, 0xc0, 0x87, 0x74, 0x60, 0x87,
  ...
  0x80, 0x87, 0x3c, 0x0a, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x0c, 0x79, 0x20, 0x20, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
  ...
  ,
  ...
  0x4b, 0x7b, 0x73, 0x9b, 0x9b, 0x22, 0x98, 0x41, 0x1b, 0xd4, 0x21, 0xc3,
  0x73, 0x29, 0x73, 0xa3, 0x93, 0xcb, 0x83, 0x7a, 0x4b, 0x73, 0xa3, 0x9b,
  0x9b, 0x22, 0xc4, 0x41, 0x1d, 0x00, 0x00, 0x00, 0x79, 0x18, 0x00, 0x00,
  ...
  
};
