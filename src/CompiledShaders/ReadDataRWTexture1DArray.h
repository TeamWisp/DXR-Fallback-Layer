...
; inputTexture                          UAV     f32     1darray      U1             u1     1
;
...
@"\01?inputTexture@@3V?$RWTexture1DArray@V?$vector@M$03@@@@A" = external constant %"class.RWTexture1DArray<vector<float, 4> >", align 4
...
define void @"\01?miss@@YAXUEmptyPayload@@@Z"(%struct.EmptyPayload* noalias %payload) #0 {
  ...
  %1 = alloca [4 x float]
  %2 = alloca [4 x float]
  %3 = load %"class.RWTexture1DArray<vector<float, 4> >", %"class.RWTexture1DArray<vector<float, 4> >"* @"\01?inputTexture@@3V?$RWTexture1DArray@V?$vector@M$03@@@@A"
  ...
  %6 = load i32, i32* %5
  store i32 %6, i32* %.0
  %7 = call %dx.types.Handle @"dx.op.createHandleForLib.class.RWTexture1DArray<vector<float, 4> >"(i32 160, %"class.RWTexture1DArray<vector<float, 4> >" %3)  ; CreateHandleForLib(Resource)
  %TextureLoad = call %dx.types.ResRet.f32 @dx.op.textureLoad.f32(i32 66, %dx.types.Handle %7, i32 undef, i32 0, i32 0, i32 undef, i32 undef, i32 undef, i32 undef)  ; TextureLoad(srv,mipLevelOrSampleCount,coord0,coord1,coord2,offset0,offset1,offset2)
...
; Function Attrs: nounwind readonly
declare %dx.types.Handle @"dx.op.createHandleForLib.class.RWTexture1DArray<vector<float, 4> >"(i32, %"class.RWTexture1DArray<vector<float, 4> >") #1
...
!7 = !{i32 1, %"class.RWTexture1DArray<vector<float, 4> >"* @"\01?inputTexture@@3V?$RWTexture1DArray@V?$vector@M$03@@@@A", !"inputTexture", i32 0, i32 1, i32 1, i32 6, i1 false, i1 false, i1 false, !8}
!8 = !{i32 0, i32 9}
!9 = !{i32 0, %struct.RWByteAddressBuffer undef, !10, %struct.EmptyPayload undef, !12, %"class.RWTexture1DArray<vector<float, 4> >" undef, !14}
!10 = !{i32 4, !11}
...
const unsigned char g_pReadDataRWTexture1DArray[] = {
  0x44, 0x58, 0x42, 0x43, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
  0xac, 0x0a, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x2c, 0x00, 0x00, 0x00,
  ...
  0x44, 0x58, 0x49, 0x4c, 0x60, 0x09, 0x00, 0x00, 0x61, 0x00, 0x06, 0x00,
  0x58, 0x02, 0x00, 0x00, 0x44, 0x58, 0x49, 0x4c, 0x01, 0x01, 0x00, 0x00,
  0x10, 0x00, 0x00, 0x00, 0x48, 0x09, 0x00, 0x00, 0x42, 0x43, 0xc0, 0xde,
  0x21, 0x0c, 0x00, 0x00, 0x4f, 0x02, 0x00, 0x00, 0x0b, 0x82, 0x20, 0x00,
  ...
  0x02, 0x00, 0x00, 0x00, 0x89, 0x20, 0x00, 0x00, 0x3b, 0x00, 0x00, 0x00,
  ...
  ,
  ...
  0x00, 0xc0, 0xec, 0x00, 0x80, 0x87, 0x3c, 0x0a, 0x00, 0x00, 0x01, 0x00,
  ...
  ,
  ...
  0xa5, 0xbd, 0xb9, 0xcd, 0x4d, 0x11, 0xca, 0x80, 0x0d, 0xea, 0x90, 0xe1,
  0xb9, 0x94, 0xb9, 0xd1, 0xc9, 0xe5, 0x41, 0xbd, 0xa5, 0xb9, 0xd1, 0xcd,
  0x4d, 0x11, 0xe0, 0x80, 0x0e, 0x00, 0x00, 0x00, 0x79, 0x18, 0x00, 0x00,
  ...
  ,
