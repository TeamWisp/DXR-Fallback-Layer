...
; ------------------------------ ---------- ------- ----------- ------- -------------- ------
; inputTexture                      texture     f32     2darray      T0             t1     1
...
@"\01?inputTexture@@3V?$Texture2DArray@V?$vector@M$03@@@@A" = external constant %"class.Texture2DArray<vector<float, 4> >", align 4
...
define void @"\01?miss@@YAXUEmptyPayload@@@Z"(%struct.EmptyPayload* noalias %payload) #0 {
  ...
  %1 = alloca [4 x float]
  %2 = alloca [4 x float]
  %3 = load %"class.Texture2DArray<vector<float, 4> >", %"class.Texture2DArray<vector<float, 4> >"* @"\01?inputTexture@@3V?$Texture2DArray@V?$vector@M$03@@@@A"
  ...
  %6 = load i32, i32* %5
  store i32 %6, i32* %.0
  %7 = call %dx.types.Handle @"dx.op.createHandleForLib.class.Texture2DArray<vector<float, 4> >"(i32 160, %"class.Texture2DArray<vector<float, 4> >" %3)  ; CreateHandleForLib(Resource)
  %TextureLoad = call %dx.types.ResRet.f32 @dx.op.textureLoad.f32(i32 66, %dx.types.Handle %7, i32 0, i32 0, i32 0, i32 0, i32 undef, i32 undef, i32 undef)  ; TextureLoad(srv,mipLevelOrSampleCount,coord0,coord1,coord2,offset0,offset1,offset2)
...
; Function Attrs: nounwind readonly
declare %dx.types.Handle @"dx.op.createHandleForLib.class.Texture2DArray<vector<float, 4> >"(i32, %"class.Texture2DArray<vector<float, 4> >") #1
...
!4 = !{!5, !8, null, null}
!5 = !{!6}
!6 = !{i32 0, %"class.Texture2DArray<vector<float, 4> >"* @"\01?inputTexture@@3V?$Texture2DArray@V?$vector@M$03@@@@A", !"inputTexture", i32 0, i32 1, i32 1, i32 7, i32 0, !7}
!7 = !{i32 0, i32 9}
!8 = !{!9}
...
!10 = !{i32 0, %struct.RWByteAddressBuffer undef, !11, %struct.EmptyPayload undef, !13, %"class.Texture2DArray<vector<float, 4> >" undef, !15, %"class.Texture2DArray<vector<float, 4> >::mips_type" undef, !18}
!11 = !{i32 4, !12}
...
const unsigned char g_pReadDataTexture2DArray[] = {
  ...
  0x4a, 0x60, 0x04, 0xa0, 0x18, 0xca, 0xa1, 0x24, 0xca, 0xa2, 0x10, 0xca,
  0xa0, 0x14, 0x0a, 0xa5, 0x40, 0x8a, 0xa0, 0x20, 0x68, 0x2b, 0x51, 0x40,
  ...
  ,
  ...
  0x1d, 0x6c, 0x28, 0x00, 0x3b, 0x00, 0x2e, 0x3c, 0x20, 0x17, 0xf0, 0xd3,
  0x96, 0x36, 0x37, 0x07, 0x04, 0x94, 0x15, 0x84, 0x55, 0x55, 0xd4, 0x06,
  0x47, 0x97, 0x07, 0x15, 0x96, 0xc7, 0xf6, 0x16, 0x46, 0x06, 0x04, 0x04,
  0xa4, 0x35, 0x41, 0x00, 0xa6, 0x0d, 0xc4, 0x1e, 0x4c, 0x48, 0xb6, 0xa1,
  ...
  0x56, 0x27, 0x37, 0x56, 0x36, 0x37, 0x25, 0xb0, 0x2a, 0x91, 0xe1, 0xb9,
  ...
  0x3f, 0x00, 0x00, 0x00, 0x36, 0x50, 0x0d, 0x97, 0xef, 0x3c, 0xfe, 0x44,
  0x5c, 0x13, 0x15, 0x11, 0xa5, 0x03, 0x0c, 0x7e, 0x71, 0xdb, 0x05, 0x80,
  0x06, 0x81, 0xdf, 0xbb, 0x4e, 0x87, 0xd7, 0xe9, 0xc2, 0xba, 0xd9, 0x5c,
  0x96, 0x03, 0x81, 0xb3, 0xaa, 0xf4, 0x2a, 0xcc, 0xd3, 0xcb, 0x41, 0x32,
  ...
  0xd2, 0x46, 0x15, 0x05, 0x11, 0x55, 0x80, 0x1d, 0x04, 0x7e, 0x69, 0x37,
  0xbc, 0x4e, 0xa7, 0x96, 0xf1, 0xf4, 0xba, 0xbc, 0x0c, 0x04, 0xce, 0xac,
  0x3f, 0x12, 0xb5, 0x8c, 0xa7, 0xd7, 0xe5, 0x65, 0x19, 0x31, 0x28, 0x97,
  0x87, 0xf3, 0x40, 0xeb, 0x8f, 0x64, 0x2f, 0x8f, 0xe9, 0x6f, 0x39, 0xb0,
  0x49, 0x82, 0xcd, 0x80, 0x40, 0x20, 0x30, 0x58, 0x02, 0x5c, 0xe0, 0xd7,
  0x4e, 0xcf, 0xe7, 0x40, 0x60, 0x36, 0x88, 0xad, 0x16, 0xdb, 0x70, 0x7a,
  0x1e, 0x1a, 0xce, 0xb3, 0xdf, 0x61, 0x32, 0x10, 0x08, 0xd4, 0x56, 0x01,
  ...
  ,
  ...
  0x86, 0x2f, 0x0f, 0xde, 0x80, 0x82, 0x01, 0xec, 0x6e, 0x08, 0x83, 0x3d,
